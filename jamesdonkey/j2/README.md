# VIA JSON file for Jamesdonkey J2
...
AND, I've built a whole new firmware based on the official sources that has Mac mode built in. Look at the "firmware" directory.
